...
export function Footer(_handle: Handle) {
  return () => (
    <footer class="app-footer">
      ...
      <div class="app-footer__links">
        ...
        <a href="https://www.rushsoft.de/privacy" target="_blank" rel="noreferrer">Privacy</a>|
        <a href="https://www.rushsoft.de/imprint" target="_blank" rel="noreferrer">Imprint</a>|
        <a
